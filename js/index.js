...
navItem[0].style.color = 'blue';
navItem[1].style.color = 'blue';
navItem[2].style.color = 'blue';
navItem[3].style.color = 'blue';
navItem[4].style.color = 'blue';
navItem[5].style.color = 'blue';

const itemsLink = document.createElement('a');
itemsLink.textContent = 'Home';
itemsLink.href = "#";
itemsLink.style.color = 'blue';
